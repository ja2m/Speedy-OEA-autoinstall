...
#Se ejecuta instalacion de paquetes de jungle-team
 ...
 Modulo_package_gestion "enigma2-plugin-softcams-cccam" "🧐  Opciones Solicitud de instalacion CCcam 2.3.2 spain" "$INSTALACION_NORMAL" "5" "extra_comando" "install_cccam_egami" "extra_comando2" "$COMANDO_CCCAM"
 if [ "$es_arm" -gt 0 ];
 then
